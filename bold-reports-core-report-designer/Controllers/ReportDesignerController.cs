...
namespace bold_reports_core_report_designer.Controllers
{
    [Route("api/[controller]/[action]")]
    [ApiController]
    public class ReportDesignerController : ControllerBase, BoldReports.Web.ReportDesigner.IReportDesignerController
    {
